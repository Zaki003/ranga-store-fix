...
// adds products to cart on 'add to cart' button click 
let count = 0;
...
// load details of a single products on 'details' button click
...
// show details of a single products on 'details' button click 
const showDetails = productInfo => {
  ...
  <div>
  <h3>Catagory: ${productInfo.category}</h3>
  <h4>${productInfo.title}</h4>
  <p>Rating: ${productInfo.rating.rate}, Rated By: ${productInfo.rating.count} users</p>
